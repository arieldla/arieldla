...
| Network | pfSense, VLANs 10/20/30, static WAN, Site-to-Site VPN (Terraform-managed) |
| PKI | Self-managed CA (JenkinsLabCA) |

**AWS (us-east-1):**
- Multi-VPC architecture (10.10.0.0/16, 10.20.0.0/16)
...
- Domains: dlagroup.io, dlagroupinc.net, dlagroupinc.com
