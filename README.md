...
Featured Repos
Repo	What It Does
jenkins-iam-roles-anywhere	Keyless AWS auth from on-prem Jenkins using X.509 certs — no static IAM keys
jenkins-terraform-pipeline	Jenkins CI/CD pipeline driving Terraform against AWS with S3 backend
jenkins-labs	12-lab progressive Jenkins series: params, remote state, shared libs, GitOps
cicd-golden-pipeline	Reusable golden pipeline template with security scanning baked in
jenkins-shared-library	Shared Groovy library for consistent pipeline steps across all Jenkins jobs
...
Connect
·	LinkedIn: linkedin.com/in/ariel-de-los-angeles-7a386b347
·	GitHub: github.com/arieldla
